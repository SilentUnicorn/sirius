 ...
 * 清洗数据
 */
public class CleanData1 {
    public static void main(String[] args) throws IOException {
        FileReader f = new FileReader("/Users/didi/test.txt");
        BufferedReader bufferedReader = new BufferedReader(f);
        File resultFile = new File("/Users/didi/distance123.txt");
        ...
        while (!StringUtils.isEmpty(str=bufferedReader.readLine())){
            ...
            Integer orderDest2FinishDistance = jsonObject.getInteger("orderDest2FinishDistance");
